    ...
    return (
      ...
      >
        <div
          ...
          dir={dir}
          className={cn(
            "flex items-center flex-wrap gap-1 p-3 px-4 rounded-lg bg-background overflow-hidden   ring-1 ring-muted  ",
            {
        ...
        >
          {value.map((item, index) => (
            <Badge
              ...
              className={cn(
                "relative px-1 bg-primary rounded flex items-center gap-1 data-[active='true']:ring-2 data-[active='true']:ring-muted-foreground truncate aria-disabled:opacity-50 aria-disabled:cursor-not-allowed",
              )}
            >
          ...
          <Input
            ...
            className={cn(
              "outline-0 border-none h-7 min-w-fit flex-1 focus-visible:outline-0 focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:border-0 placeholder:text-gray-400 px-1",
